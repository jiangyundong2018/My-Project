        ...
        <div class="col-sm-8 blog-main">
            <div class="blog-post">
                <div style="display:inline-flex">
                    ...
                    @can('delete',$post)
                    <a style="margin: auto"  href="/del/{{$post->id}}">
                ...
                <p><p>{{$post->content}}<img src="http://127.0.0.1:8000/storage/72c76b674ec8793fcfd6555ff371bfbd/nxC9ozLfkORmoY92q9lPsejXchVvdNO2cwHiR2Jf.jpeg" alt="63" style="max-width: 100%;"></p><p><br></p></p>

                <div>
                    @if($post->zans(\Auth::id())->exists())
                        <a href="/post/unzan/{{$post->id}}" type="button" class="btn btn-primary btn-lg">取消赞</a>
                    @else
                        <a href="/post/zan/{{$post->id}}" type="button" class="btn btn-primary btn-lg">赞</a>
                    @endif
                </div>
